...
const Sidebar = () => {
  return (
    <aside className="w-[20vw] " aria-label="Sidebar">
   <div className="overflow-y-auto h-[90vh] relative py-4 px-3 bg-gray-50 rounded dark:bg-slate-900">
      ...
      <div id="dropdown-cta" className="p-4 absolute bottom-10 left-2 right-2 mt-6 bg-blue-50 rounded-lg dark:bg-blue-900" role="alert">
